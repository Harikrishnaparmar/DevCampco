...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content-qube">
        <div class="width-container-qube">
            <div class="vc_col-md-12 vc_col-xs-12">
                        ...
                        <div class="shop-post-single-container-pro gallery-of-images-top">
                            <div itemscope itemtype="" id="product-1773" class="post-1773 product type-product status-publish has-post-thumbnail product_cat-shoes product_tag-black product_tag-leather product_tag-shoes product_tag-women shipping-taxable purchasable product-type-simple product-cat-shoes product-tag-black product-tag-leather product-tag-shoes product-tag-women instock">
                                ...
                                <div class="images gallery-of-images">
                                    ...
                                    <a href="#<%=Prod_Detail.EXTRAPIC %>" itemprop="image" class="woocommerce-main-image jzoom" title="" >
                                        <div class="imgLoader_center"></div>
                                        <img width="600" height="600" src="<%=Prod_Detail.EXTRAPIC %>" class="attachment-shop_single size-shop_single wp-post-image imgLoad" alt=""   srcset="<%=Prod_Detail.EXTRAPIC+","+imgsrc %>" sizes="(max-width: 600px) 100vw, 600px" />
                                    </a>
                                    
                                    <div class="thumbnails columns-3">
                                        <a href="javascript:void(0);" picsrc="<%=Prod_Detail.LARGEPIC %>" class="zoom first" title="" data-rel="">
                                            <img width="180" height="180" src="<%=Prod_Detail.SMALLPIC %>" class="attachment-shop_thumbnail size-shop_thumbnail" alt="3_2961125" srcset="<%=Prod_Detail.LARGEPIC%>" />
                                        </a>
                                        <%foreach (var item in Prod_Detail.extraPic)
                                            {%>
                                        <a href="javascript:void(0);" picsrc="<%=item.LargePic %>" class="zoom first" title="" data-rel="">
                                            <img width="180" height="180" src="<%=item.smallPic %>" class="attachment-shop_thumbnail size-shop_thumbnail" alt="3_2961125" title="2_2961125" srcset="../Pic/<%=item.midPic %>" />
                                        </a>
                                        <%} %>
                                    </div>
                                </div>
                                <div class="summary entry-summary">
                                    ...
                                    <div id="cart" class="cart">
                                        <div class="quantity">
                                            ...
                                            <%if ((HttpContext.Current.Session["customerType"] != null ? HttpContext.Current.Session["customerType"].ToString() : "1") == "1"){ if(Prod_Detail.MINSTOCK!="Out of Stock: Available for Backorder") { %>
                                            ...
                                            <%}}else {%>
                                            <asp:Button ID="Button1" CssClass="single_add_to_cart_button button wpcf7-form-control wpcf7-submit" runat="server" Text="ADD TO CART" OnClick="AddToCart_Click" />
                                            <%}%>
                                        </div>
                                    </div>
                                    <%--</form>--%>
...
-->
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery(document).delegate('img.imgLoader', 'load', function (element) {
                jQuery('.imgLoader_center').hide();
